...
"product_price_no_VAT": <float> або <String> - ціна товару без ПДВ,
"VAT_value": <float> або <String> - розмір ПДВ,
"excise_value": <float> або <String> - розмір акцизу. Якщо не передено - буде збережено значення 0
